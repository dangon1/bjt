...
public class Constants {
	...
	public static final Integer INITIAL_CASH = 10000;
	public static final Integer MINIMUM_BET = 10;
	public static final Integer MAX_NUMBER_OF_PLAYS = 10000;
	public static final Integer DEALER_DRAW_UNTIL = 16;
	public static final boolean CAN_ALWAYS_DOUBLE_DOWN = false;
	public static final Integer NUMBER_OF_DECKS = 6;
	
	
	public static final boolean DOUBLE_DOWN_AFTER_SPLIT = false;
	public static final Integer DECKS_CUT_OFF = 1;
	public static final Double BLACKJACK_PAYOUT = 3.0/2.0;
	public static final boolean PLAYER_BJ_BEATS_DEALER_BJ = false;
	public static final boolean STANDS_SOFT_17 = true;
	public static final boolean EARLY_SURRENDER = false;
